...
// Đã chỉnh: nút "Bắt đầu hành trình ngay" => "Đặt Tour" (Link đến /booking)

import { Link } from "react-router-dom"; // cần dùng Link
...
export const events = [
  {
    ...
    date: "01/09 - 03/09",
    image:
      "https://cdn.thuvienphapluat.vn/uploads/tintuc/2025/08/12/lich-nghi-le-quoc-khanh-2-9-nguoi-lao-dong.jpg",
    description:
      "Khám phá Đà Nẵng, tận hưởng lễ hội pháo hoa rực rỡ cùng những hoạt động sôi động.",
  },
  {
    id: 2,
    ...
    date: "20/04 - 27/04",
    image:
      "https://danangfantasticity.com/wp-content/uploads/2023/04/le-hoi-phao-hoa-quoc-te-da-nang-2023-diff-2023-the-gioai-khong-khoang-canh-tu-02-06-den-08-07-2023.jpg",
      ...
      <section className="w-full bg-gradient-to-br from-blue-50 to-white">
        <div className="mx-auto max-w-3xl px-6 py-16 text-center">
          ...
          <p className="text-lg text-gray-700 leading-7 mb-6">
            Tại <span className="font-semibold">TravelTour</span>, chúng tôi tin rằng du lịch không
            chỉ là đi từ điểm A đến điểm B, mà là hành trình khám phá bản thân qua những trải
            nghiệm mới.
          </p>
          ...
          <div className="mt-8">
            {/* Thay nút "Bắt đầu hành trình ngay" bằng Link tới /booking và text "Đặt Tour" */}
            <Link
              to="/booking"
